...
* serve as a pilot study from which to build a more generalizable framework to analyze efforts and programs designed to improve student success across campus.
* provide a picture of the type of student that succeeds in Chem 111.
* rigorously analyze the effect of course redesign on student success.
* provide a valuable part of the process improvement in student success. 



# The Project Team

* **[Robin Donatello](www.norcalbiostat.com)** Faculty, Department of Mathematics and Statistics. Statistics and Data expert. 
