...
```{r, results='show'}
kable(g.term$table, row.names = FALSE, align='c') %>%  kable_styling(bootstrap_options="striped", full_width=F)
...
```{r, results='show'}
kable(a[,1:4], digits=2, align='c', caption="Full Sample") %>% 
  kable_styling(bootstrap_options="striped", full_width=F, position = "float_left")

kable(a[,c(1,5:7)], digits=2, align='c', caption="F14-F16 only") %>% 
