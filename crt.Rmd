...
#### Performance - GPA
GPA and Age have a non-linear relationship. For students less than 25 years of age, the pattern of relationship between age and GPA does not significantly differ across the three course types. This indicates that the intervention has a similar affect on a students GPA regardless of their age. 
```{r, fig.width=10}
