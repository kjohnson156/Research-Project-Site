...
* The aim is to use data to provide support to the current [Sustaining Success](https://contentbuilder.merlot.org/toolkit/html/snapshot.php?id=61030667052633) project for Chem 111. 

* Specifically we use data visualization and statistical analysis techniques to 
    - understand how the set of students taking Chem 111 compares to the overall campus population. 
    - understand how the characteristics of this group have changed over the past 5 years. 
...
* Examining how the characteristics of students taking Chemistry 111 are changing allows instructors to better understand the students that they are serving. 
    - This could lead to development of culturally relevant teaching strategies or curriculum. 

* Furthermore, this information will be useful to administration to ensure support systems are in place to serve the current and future student body. 
